/**
 * Public surface for `@zachary/trellis-core/mem` — reusable retrieval and
 ...
 * `@zachary/trellis-core` barrel. Import it explicitly:
 *
 *   import { searchMemSessions } from "@zachary/trellis-core/mem";
 *

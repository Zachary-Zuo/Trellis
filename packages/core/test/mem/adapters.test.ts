...
const { opencodeDataDir, opencodeDbPath, HOME, devinCliDataDir, devinCliDbPath } =
  await import("../../src/mem/internal/paths.js");
...
// =============================================================================
// Devin CLI adapter — Cognition `sessions.db` via the zero-dependency SQLite
// parser. Fixtures are built with the system python sqlite3 module; the block
// is skipped when no interpreter is available. This is NOT Trellis `--devin`
// (Desktop / former Windsurf) and NOT Factory Droid.
// =============================================================================

const DEVIN_PY = SQLITE_PY;
